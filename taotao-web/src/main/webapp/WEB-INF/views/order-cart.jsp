...
<form id="orderForm" class="hide">
		...
		<input type="hidden" name="orderShipping.receiverName" value="许子毅"/>
		...
		<input type="hidden" name="orderShipping.receiverAddress" value="建材城西路金燕龙办公楼"/>
	</form>
...
<div class="step-cont">
	...
	<div class="consignee-item item-selected" consigneeId="137617472" id="consignee_index_div_137617472">
		<b></b>
		<div class="user-name">
			<div class="fl"><strong limit="4">许子毅</strong>&nbsp;&nbsp;收</div>
